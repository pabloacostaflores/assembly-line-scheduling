var cy = window.cy = cytoscape({
  ...
  elements: {
    nodes: [
      ...
      { data: { id: 'x' } },
      { data: { id: 'a', num: 4, parent: 'x' }, position: { x: 200, y: 85 } },
      { data: { id: 'b', num: 5, parent: 'x' }, position: { x: 250, y: 85 } },
      { data: { id: 'c', num: 3, parent: 'x' }, position: { x: 300, y: 85 } },
      { data: { id: 'd', num: 2, parent: 'x' }, position: { x: 350, y: 85 } },
      
      //{ data: { id: 'aux', num: 0}, position: { x: 450, y: 85 } },
      { data: { id: 'y' } },
      //{ data: { id: 'aux', num: 0}, position: { x: 150, y: 150 } },
      { data: { id: 'f', num: 2, parent: 'y' }, position: { x: 200, y: 150 } },
      { data: { id: 'g', num: 10, parent: 'y' }, position: { x: 250, y: 150 } },
      { data: { id: 'h', num: 1, parent: 'y' }, position: { x: 300, y: 150 } },
      { data: { id: 'i', num: 4, parent: 'y' }, position: { x: 350, y: 150 } },
